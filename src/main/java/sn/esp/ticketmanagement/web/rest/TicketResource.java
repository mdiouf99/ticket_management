...
import sn.esp.ticketmanagement.security.SecurityUtils;
import sn.esp.ticketmanagement.web.rest.errors.BadRequestAlertException;
import tech.jhipster.web.util.HeaderUtil;
import tech.jhipster.web.util.ResponseUtil;

/**
 * REST controller for managing {@link sn.esp.ticketmanagement.domain.Ticket}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class TicketResource {
    ...
    public ResponseEntity<Ticket> partialUpdateTicket(
        ...
        Optional<Ticket> result = ticketRepository
            ...
            .map(existingTicket -> {
                if (ticket.getLibelle() != null) {
                    existingTicket.setLibelle(ticket.getLibelle());
                }
    ...
    public List<Ticket> getAllTickets() {
        ...
        if (SecurityUtils.hasCurrentUserThisAuthority("ROLE_CLIENT")) return ticketRepository.findByUserIsCurrentUser(); else if (
            SecurityUtils.hasCurrentUserThisAuthority("ROLE_SUPPORT")
        ) return ticketRepository.findByActiveTickets(); else return ticketRepository.findAll();
    }
